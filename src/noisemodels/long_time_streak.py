...
from .utils import get_round_pairs, get_round_pair_distances, calc_marginals
...
class LongTimeStreak(LongTimePair):
    ...
    def int_to_bool_errors(self, errors: np.ndarray) -> np.ndarray:
        ...
        random_bits = rng.integers(0, 1, size=qubit_errors.shape, endpoint=True)
        return random_bits * qubit_errors
